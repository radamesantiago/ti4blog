...
def destaque():
    ...
    list_destaque = Post.objects.filter(destaque='1').order_by('-data_criacao')[:3]
...
def index(request):
    if request.method == 'GET':
        ...
        paginator = Paginator(list_post, 4)
        ...
        return render_to_response('posts/index.html', {"list_post": posts,"list_destaque": destaque()})  
